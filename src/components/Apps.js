...
export default class Apps extends Component {
    render() {
        ...
        const upnext = "This is a Full-stack application. This app has a built in timer for the each order that will help you monitor your food prep time so you don't need to wait in line. Technologies: MongoDB, Express, Node.js, and Handle-bar/CSS";
